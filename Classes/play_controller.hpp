/* $Id: play_controller.hpp 31859 2009-01-01 10:28:26Z mordante $ */
/*
...
protected:
	...
	void show_menu(const std::vector<shared_string>& items_arg, int xloc, int yloc, bool context_menu);
...
private:
	...
	void expand_autosaves(std::vector<shared_string>& items);
	std::vector<shared_string> savenames_;

	void expand_wml_commands(std::vector<shared_string>& items);
