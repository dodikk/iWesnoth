/* $Id: preferences.cpp 33440 2009-03-08 16:48:17Z baufo $ */
/*
...
std::pair<int,int> resolution()
{
	...
	std::string xStr = "x" + postfix;
	std::string yStr = "y" + postfix;
	const string_map::const_iterator x = prefs.values.find(xStr);
	const string_map::const_iterator y = prefs.values.find(yStr);
