/* $Id: string_utils.hpp 32947 2009-02-20 20:45:44Z ilor $ */
/*
...
typedef std::vector<unsigned short> ucs2_string;
typedef std::vector<unsigned long> ucs4_string;
...
std::vector< shared_string > split_shared(std::string const &val, char c = ',', int flags = REMOVE_EMPTY | STRIP_SPACES);
 ...
 *
 * @param[in]  str     std::string which can be converted to utf-8.
 * @param[out] str     std::string which contains maximal size utf-8 characters.
