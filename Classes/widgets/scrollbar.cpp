/* $Id: scrollbar.cpp 33458 2009-03-08 18:45:28Z mordante $*/
/*
...
//	surface const screen = video().getSurface();
	...
	// Draw scrollbar "grip"
	blit_surface(grip.x, grip.y, top_img);
	blit_surface(grip.x, grip.y + top_img->h, mid_scaled_);
	blit_surface(grip.x, grip.y + top_img->h + mid_height, bottom_img);
